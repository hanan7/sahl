...
<div class="lockscreen-wrapper">
  ...
  <!-- User name -->
  <div class="lockscreen-name" style="color: #f4f4f4;">أسم المستخدم</div>
    ...
    <form class="lockscreen-credentials">
      <div class="input-group">
        ...
        <div class="input-group-btn">
          <button type="button" class="btn"><i class="fa fa-arrow-left text-muted"></i></button>
        </div>
      </div>
    </form>
  ...
  <!-- /.lockscreen-item -->
  <div class="help-block text-center" style="color: #eee;">
    أدخل كلمة المرور لإستعادة الجلسة
  </div>
  <div class="text-center">
    <a href="login.html">أو قم بتسجيل الدخول كمستخدم أخر</a>
  </div>
