  ...
  <div class="login-box-body">
    ...
    <form action="#" method="post">
      <div class="form-group has-feedback">
        <input type="email" class="form-control" placeholder="اسم المستخدم أو البريد الإليكترونى" required>
    ...
    <a href="Rcovery%20password.html">نسيت كلمة المرور؟</a><br>
    <a href="register.html" class="text-center">تسجيل مستخدم جديد ؟</a>
