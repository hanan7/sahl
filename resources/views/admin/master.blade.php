...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                                        ...
                                        <ul class="menu">
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <h4>
                                                        ...
                                                        <small><i class="fa fa-clock-o"></i>2 من الساعات</small>
                                                    </h4>
                                                    <p>Why not buy a new awesome theme?</p>
                                                </a>
                                            </li>
                                            ...
                                            <li>
                                                <a href="#">
                                                    ...
                                                    <h4>
                                                        Sales Department
                                                        <small><i class="fa fa-clock-o"></i> بالأمس</small>
                                                    </h4>
                                                    <p>Why not buy a new awesome theme?</p>
                                                </a>
                                            </li>
                            ...
                            <li class="dropdown notifications-menu">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="header">لديك 10 اشعارات</li>
                                    <li>
                                        <!-- inner menu: contains the actual data -->
                                        <ul class="menu">
                                            <li>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    <span class="hidden-xs">نادى شلبى</span>
                                </a>
                                <ul class="dropdown-menu">
                                    <!-- User image -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="index.html"><i class="fa fa-circle-o"></i>الرئيسية</a></li>
                                <li><a href="statistics.html"><i class="fa fa-circle-o"></i>إحصائيات</a></li>
                                <li><a href="employees.html"><i class="fa fa-circle-o"></i>الموظفين</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i>المستخدمين</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i>العملاء</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="Main-Agents.html"><i class="fa fa-circle-o"></i> وكلاء رئيسيين</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> وكلاء فرعيين</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#"><i class="fa fa-circle-o"></i>مخازن رئيسية</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i>مخازن فرعية</a></li>
                                <li><a href="#"><i class="fa fa-circle-o"></i> مخازن الوكلاء</a></li>
        ...
        <script src="{{ asset('assets/dist/js/jquery.nicescroll.js') }}"></script>
